...
function Home(props) {
    ...
    return (
        <div style={{marginTop:'120px'}}>
            <Typography variant='h2' className="all_categories_heading" my={6} sx={{ textShadow: "2px 2px 6px grey", color: 'black',  fontWeight: 'bold', textAlign: 'center', textDecoration: 'underline' }}>All Categories</Typography>
            {/* Zippers */}
